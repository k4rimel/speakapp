	...
	<div class="row">
      ...
      <div class="col-md-9 personal-info">
        ...
        <form class="form-horizontal" role="form">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label">Hometown location:</label>
            <div class="col-lg-8">
              <input class="form-control" type="text" value="{{$profile->hometownLocation}}">
            </div>
          </div>          
          <div class="form-group">
            <label class="col-lg-3 control-label">Current location:</label>
            <div class="col-lg-8">
              <input class="form-control" type="text" value="{{$profile->currentLocation}}">
            </div>
          </div>
          <div class="form-group">
